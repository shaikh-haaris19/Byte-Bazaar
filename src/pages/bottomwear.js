...
const bottomwear = ({ allProducts }) => {
    ...
    return (
        <div>
            <Head>
                <title>BottomWear - ByteBazaar.com</title>
            </Head>
            <section className="text-gray-600 body-font min-h-screen">
                <div className="container px-5 py-24 mx-auto">
                    <div className="flex flex-wrap -m-4 justify-center">
                        ...
                        {
                            Object.keys(allProducts).length === 0 && <p className='mx-auto py-5'>Sorry All BottomWear Product Are Out Of Stock. New Stock Coming Soon. Stay Tuned!</p>
                        }
    ...
    for (let item of allProducts) {
        ...
        if (item.title in bottomwear) {
            ...
            if (item.availableQty > 0) {
                ...
                bottomwear[item.title].color = []
                bottomwear[item.title].size = []
            }
        }
