      ...
      <div className='m-3 p-3'>
        ...
        <div className="cart py-8 px-8 text-blue-950 border text-xl lg:text-lg prata-regular m-3">
          ...
          <div className="flex items-center flex-col md:flex-row md:justify-end">
            ...
            <Link href={'/checkout'}>
              <button className="flex items-center gap-2 mx-2 mt-1 md:mt-5 text-white bg-green-600 border-0 py-2 px-6 md:px-10 focus:outline-none hover:bg-green-800 rounded text-sm md :text-xl w-full cursor-pointer transform transition-transform duration-100 hover:scale-110 prata-regular">Pay<FaShoppingBag />
              </button>
            </Link>
          </div>
